...
// Nombre: nav
// Versión: 3.0
// Sitio Web: https://github.com/ivarcia/codelab-nav
//----------------------------------//
...
$(document).ready(function () {
    ...
    //------------------------------  CONFIGURACIÓN  -------------------------------//
    var button = '#nav_button'; //Elemento en el que pulsamos para abrir y cerrar el menú.
    var menu = '#nav--bar'; //Elemento que contiene el menú responsive.
    ...
    var navShadow = "nav_shadow";
    var navShadowID = '#' + navShadow;
    ...
    function open() {
        ...
        if (shadow == 'yes') {
            $("<div>", {
                id: navShadow, //atributo directo, igual que si fuéramos con attr(“id”)
            ...
            $(navShadowID).fadeTo(speedM, opacity);
        }
    };
    ...
    $(document).on('click', navShadowID, function () {
        close(normalTime);
    });
